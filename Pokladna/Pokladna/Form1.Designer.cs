namespace Pokladna
{
 partial class Form1
 {
  ...
  private void InitializeComponent()
  {
   ...
   this.cboxTridit = new System.Windows.Forms.ComboBox();
   this.label8 = new System.Windows.Forms.Label();
   this.chboxSestupne = new System.Windows.Forms.CheckBox();
   ...
   this.panel1.Controls.Add(this.chboxSestupne);
   this.panel1.Controls.Add(this.label8);
   this.panel1.Controls.Add(this.cboxTridit);
   ...
   this.lvData.KeyUp += new System.Windows.Forms.KeyEventHandler(this.lvData_KeyUp);
   // 
   // columnHeader1
   // 
   ...
   // cboxTridit
   // 
   this.cboxTridit.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
   this.cboxTridit.FormattingEnabled = true;
   this.cboxTridit.Items.AddRange(new object[] {
            "Datum",
            "Popis",
            "Příjmy",
            "Výdaje"});
   this.cboxTridit.Location = new System.Drawing.Point(94, 349);
   this.cboxTridit.Name = "cboxTridit";
   this.cboxTridit.Size = new System.Drawing.Size(148, 24);
   this.cboxTridit.TabIndex = 4;
   this.cboxTridit.SelectedIndexChanged += new System.EventHandler(this.cboxTridit_SelectedIndexChanged);
   // 
   // label8
   // 
   ...
   // chboxSestupne
   // 
   this.chboxSestupne.AutoSize = true;
   this.chboxSestupne.Location = new System.Drawing.Point(14, 390);
   this.chboxSestupne.Name = "chboxSestupne";
   this.chboxSestupne.RightToLeft = System.Windows.Forms.RightToLeft.Yes;
   this.chboxSestupne.Size = new System.Drawing.Size(90, 21);
   this.chboxSestupne.TabIndex = 6;
   this.chboxSestupne.Text = "Sestupně";
   this.chboxSestupne.UseVisualStyleBackColor = true;
   this.chboxSestupne.CheckedChanged += new System.EventHandler(this.chboxSestupne_CheckedChanged);
   // 
   // Form1
   // 
  ...
  private System.Windows.Forms.CheckBox chboxSestupne;
  private System.Windows.Forms.Label label8;
  private System.Windows.Forms.ComboBox cboxTridit;
 }
}
